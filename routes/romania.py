...
def zona_analisi_ro():
    try:
        ...
        add(raw_sup,    'supermercati',  '#22c55e', 'S')
        add(raw_conv,   'supermercati',  '#16a34a', 'S')
        add(raw_hyp,    'supermercati',  '#15803d', 'S')
        add(raw_farm,   'farmacie',      '#ec4899', 'F')
        add(raw_bar,    'bar',           '#f59e0b', 'B')
        add(raw_cafe,   'bar',           '#d97706', 'C')
        add(raw_rest,   'ristoranti',    '#f97316', 'R')
        add(raw_bank,   'banche',        '#06b6d4', '$')
        add(raw_atm,    'banche',        '#0891b2', '$')
        add(raw_park,   'parcheggi',     '#64748b', 'P')
        add(raw_metro,  'trasporti',     '#6d28d9', 'M')
        add(raw_bus,    'trasporti',     '#7c3aed', 'T')
        add(raw_train,  'trasporti',     '#8b5cf6', 'T')
        add(raw_scol,   'istruzione',    '#0ea5e9', 'U')
        add(raw_scuola, 'istruzione',    '#0284c7', 'U')
        add(raw_osp,    'ospedali',      '#ef4444', 'H')
        add(raw_cas,    'caserme',       '#dc2626', 'K')
        add(raw_hotel,  'hotel_bb',      '#a855f7', 'L')
        add(raw_gym,    'altro',         '#14b8a6', 'G')
